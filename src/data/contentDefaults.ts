...
export const UEBERUNS_DEFAULT: UeberUnsContent = {
  ...
  intro_disclaimer: 'Kein Interessenkonflikt. Kein Mandat. Nur Menschen, die dasselbe Problem haben wie Sie.',
  ...
  warum_text1: 'Wir verdienen kein Geld daran, dass Sie die Plattform nutzen. Wir verdienen Geld, wenn ein Anwalt aus unserem Netzwerk Ihren Fall erfolgreich abschließt — erst dann zahlt die Kanzlei eine Provision an uns.',
  warum_text2: 'Das bedeutet: Unser Interesse ist dasselbe wie Ihres. Wir helfen Ihnen nur dann, wenn wir Ihnen wirklich helfen können.',
}
